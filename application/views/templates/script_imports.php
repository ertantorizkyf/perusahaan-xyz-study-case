    ...
    <div class="modal fade" id="logoutModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">Klik tombol keuar untuk mengakhiri sesi ini.</div>
    ...
    <script src="<?php echo base_url(); ?>assets/sb_admin/js/demo/chart-area-demo.js"></script>
    <script src="<?php echo base_url(); ?>assets/sb_admin/js/demo/chart-pie-demo.js"></script>
